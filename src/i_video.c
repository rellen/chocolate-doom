...
typedef struct screenbuffer_t {
  pixel_t pixels[SCREENWIDTH * SCREENHEIGHT];
} screenbuffer_t;

static void *screen = NULL;
static void *renderer = NULL;
static void *texture = NULL;
static void *texture_upscaled = NULL;
static screenbuffer_t *screenbuffer = NULL;
static void *argbbuffer = NULL;
...
static void AdjustWindowSize(void)
{
  ...
  DEH_printf("adjusting window size.\n");
...
void I_GetWindowPosition(int *x, int *y, int w, int h)
{
  ...
  DEH_printf("getting window position.\n");
...
static void SetVideoMode(void)
{
    ...
    if (screenbuffer == NULL)
    {
      ...
      screenbuffer = malloc(sizeof(screenbuffer_t));
...
{
  DEH_printf("At start of init graphics.\n");
    /* SDL_Event dummy; */
    byte *doompal;
    char *env;
    ...
    // on configuration.
    DEH_printf("about to adjust window size.\n");
    AdjustWindowSize();
    DEH_printf("about to set video mode.\n");
    SetVideoMode();

    DEH_printf("set video mode.\n");
    ...
    DEH_printf("screenbuffer dereference.\n");
    I_VideoBuffer = screenbuffer->pixels;
    DEH_printf("about to restore buffer.\n");
    V_RestoreBuffer();

    // Clear the screen to black.

    DEH_printf("about to memset.\n");
    ...
    DEH_printf("about to exit init graphics.\n");
